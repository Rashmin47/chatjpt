import 'package:chatjpt/widgets/message_bubble.dart';
        ...
        return ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            ...
            if(nextUserIsSame) {
              ...
              return MessageBubble.first(userImage: 'https://img.icons8.com/fluent/1200/user-male-circle.jpg', username: chatMessage['username'], message: chatMessage['text'], isMe: authenticatedUser.uid == currentMessageUserId);
            }
          }
        );
      },
